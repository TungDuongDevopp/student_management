...
<div class="creative-card">
    <div class="creative-header">
        ...
        <h1 class="creative-title">Quản lý Điểm số</h1>
    </div>
    
    <div class="creative-body">
        <i class="fa-solid fa-wand-magic-sparkles" style="font-size: 3rem; color: #cbd5e1;"></i>
        <h3>Giao diện đang được xây dựng</h3>
        <p>Phần <strong>Quản lý Điểm số</strong> sẽ được cập nhật giao diện chi tiết sau. Hiện tại đã tích hợp thành công Sidebar.</p>

...
@section('content')
<div style="background-color: #f9fafb; min-height: 100vh; padding: 4rem 1rem; font-family: 'Inter', -apple-system, sans-serif; display: flex; flex-direction: column; align-items: center;">
    
    <div style="width: 100%; max-width: 440px;">
        <!-- Back button -->
        <a href="{{ route('admin.info') }}" style="display: inline-flex; align-items: center; gap: 0.5rem; color: #6b7280; text-decoration: none; font-size: 0.9rem; font-weight: 500; margin-bottom: 2rem; transition: color 0.2s;" onmouseover="this.style.color='#111827'" onmouseout="this.style.color='#6b7280'">
            ...
            <div style="padding: 0 2.5rem 2.5rem;">
                ...
                <form action="{{ route('admin.change_password.post') }}" method="POST">
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        ...
                        <input type="password" name="old_password" style="width: 100%; padding: 0.75rem 1rem; border: 1px solid #d1d5db; border-radius: 8px; background: #fff; color: #111827; font-size: 0.95rem; outline: none; transition: all 0.2s; box-sizing: border-box;" onfocus="this.style.borderColor='#2563eb'; this.style.boxShadow='0 0 0 3px rgba(37, 99, 235, 0.1)';" onblur="this.style.borderColor='#d1d5db'; this.style.boxShadow='none';" required>
                    ...
                    <div style="display: flex; justify-content: flex-end; margin-bottom: 2rem; margin-top: -1rem;">
                        <a href="{{ route('password.request') }}" style="font-size: 0.85rem; color: #2563eb; text-decoration: none; font-weight: 500; transition: color 0.2s;" onmouseover="this.style.color='#1d4ed8'" onmouseout="this.style.color='#2563eb'">Quên mật khẩu?</a>
                    </div>

                    <button type="submit" style="width: 100%; background: #2563eb; color: #fff; padding: 0.85rem 1.5rem; font-size: 0.95rem; font-weight: 600; border-radius: 8px; border: none; cursor: pointer; transition: background 0.2s; text-transform: uppercase; letter-spacing: 0.5px;" onmouseover="this.style.background='#1d4ed8'" onmouseout="this.style.background='#2563eb'">
                        Lưu mật khẩu
                    </button>
                </form>
            </div>

...
<style>
    ...
    .page-hero { background:linear-gradient(135deg,#7f1d1d 0%,#dc2626 100%);color:#fff;border-radius:10px;padding:1.25rem 1.5rem;display:flex;justify-content:space-between;align-items:center;gap:1rem;position:relative;overflow:hidden;margin-bottom:0.25rem;border:1px solid #991b1b; }
    ...
    .sem-badge { background:#fff;color:#dc2626;border-radius:6px;padding:.35rem .75rem;font-size:.75rem;font-weight:700;position:relative;z-index:1; }
        ...
        <form id="feedbackForm">
            ...
            <div class="form-row" style="margin-bottom: 1rem;">
                <div class="form-group">
                    ...
                    <input type="text" class="form-input"
                        value="{{ Auth::user()->teacher->faculty->name ?? '—' }}"
                        readonly style="background:#f8fafc; color:#64748b;">
                </div>
                <div class="form-group">
                    <label class="form-label">Email liên hệ</label>
                    <input type="email" class="form-input"
                        value="{{ Auth::user()->teacher->email ?? '' }}"
                        readonly style="background:#f8fafc; color:#64748b;">
                </div>
            </div>

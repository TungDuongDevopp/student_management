            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select id="feedback-category" name="category" class="form-select" required>
                        ...
                        <option value="service">Dịch vụ giảng viên</option>
    ...
    <section class="history-section" aria-label="Lịch sử phản hồi">
        ...
        <div class="history-item">
            <div>
                ...
                <p class="history-preview">Máy lạnh phòng A3-302 không hoạt động từ ngày 28/04, ảnh hưởng đến việc học tập của giảng viên...</p>
        ...
        <div class="history-item">
            <div>
                <p class="history-title">Đề xuất mở thêm lớp đang giảng dạy Trí tuệ nhân tạo</p>
                <p class="history-preview">Em muốn đề xuất Khoa CNTT mở thêm lớp đang giảng dạy AI vào kỳ Hè 2026 vì nhu cầu đăng ký rất cao...</p>

    ...
    <main class="info-container">
        <section class="profile-header">
            ...
            <div class="profile-main">
                ...
                <p>Hệ Đại học chính quy · Lớp {{ $student?->classroom?->code ?? 'N/A' }}</p>
                <p>Mã sinh viên: {{ $student?->student_code ?? 'N/A' }} · Khoa:
                    {{ $student?->classroom?->faculty?->name ?? 'N/A' }}</p>
        ...
        <section class="content-grid">
            <div class="info-card">
                ...
                <div class="info-list">
                    <div class="info-item">
                        ...
                        <p class="info-value">{{ $student?->name ?? 'N/A' }}</p>
                    </div>
                    <div class="info-item">
                        <p class="info-label">Mã sinh viên</p>
                        <p class="info-value">{{ $student?->student_code ?? 'N/A' }}</p>
                    </div>
                    <div class="info-item">
                    ...
                    <div class="info-item">
                        <p class="info-label">Email trường</p>
                        <p class="info-value">{{ $student?->email ?? (auth()->user()->username ?? 'N/A') }}</p>
                    </div>
                    <div class="info-item">
                        <p class="info-label">Số điện thoại</p>
                        <p class="info-value">{{ $student?->phone_number ?? 'N/A' }}</p>
                    </div>
                    <div class="info-item">
                        <p class="info-label">Địa chỉ</p>
                        <p class="info-value">{{ $student?->address ?? 'N/A' }}</p>
                    </div>
                    <div class="info-item">
                        <p class="info-label">Khoa</p>
                        <p class="info-value">{{ $student?->classroom?->faculty?->name ?? 'N/A' }}</p>
                    </div>
                    <div class="info-item">
                        <p class="info-label">Chuyên ngành</p>
                        <p class="info-value">{{ $student?->specialization ?? 'N/A' }}</p>
                    </div>
                    <div class="info-item">
                        <p class="info-label">Lớp</p>
                        <p class="info-value">{{ $student?->classroom?->code ?? 'N/A' }}</p>
                    </div>
                </div>
            </div>
            ...
            <aside class="info-card">
                ...
                <div class="action-row">
                    <a href="{{ route('student.schedule') }}" class="btn btn-primary"><i
                            class="fa-regular fa-calendar"></i> Xem lịch học tập</a>
                    <a href="{{ route('student.grades') }}" class="btn"><i class="fa-solid fa-clipboard-list"></i> Bảng
                        điểm tích lũy</a>
                    <a href="{{ route('student.tuition') }}" class="btn"><i class="fa-solid fa-money-bill"></i> Đóng học
                        phí</a>

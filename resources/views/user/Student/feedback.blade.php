...
@section('content')
    ...
    <div class="feedback-container">
        ...
        <header class="page-header">
            ...
            <p>Gửi ý kiến, góp ý hoặc phản hồi đến Nhà trường. Mọi phản hồi sẽ được tiếp nhận và xử lý trong vòng 3–5 ngày
                làm việc.</p>
        </header>
        ...
        <section class="feedback-form" aria-label="Form gửi phản hồi">
            <form action="#" method="POST" enctype="multipart/form-data" id="feedbackForm">
                ...
                <div class="form-group">
                    <label class="form-label" for="feedback-content">Nội dung chi tiết <span
        ...
        <section class="history-section" aria-label="Lịch sử phản hồi">
            ...
            <div class="history-item">
                <div>
                    ...
                    <p class="history-preview">Máy lạnh phòng A3-302 không hoạt động từ ngày 28/04, ảnh hưởng đến việc học
                        tập của sinh viên...</p>
            ...
            <div class="history-item">
                <div>
                    ...
                    <p class="history-preview">Em muốn đề xuất Khoa CNTT mở thêm lớp học phần AI vào kỳ Hè 2026 vì nhu cầu
                        đăng ký rất cao...</p>
